...
- A IA ajudou a transformar requisitos em entregas incrementais (UI, lógica, testes, documentação).
...
- Alinhar o comportamento real com requisitos que mudaram durante o desenvolvimento (ex.: limite de tamanho da senha e padrão de tema).
